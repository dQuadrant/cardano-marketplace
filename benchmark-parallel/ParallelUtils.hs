...
import Cardano.Marketplace.V1.Core (buyToken, marketAddressShelley, placeOnMarket, queryMarketUtxos, signAndSubmitTxBody)
...
pollForTxIdAtomic :: ChainInfo v => v -> AddressAny -> TxId -> (AddressAny -> IO (UTxO BabbageEra)) -> IO ()
